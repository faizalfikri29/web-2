<div class="container mx-auto">
    ...
    <div class="flex justify-between mb-4">
        <flux:button :href="route('peminjaman.create')" class="bg-green-500 hover:bg-green-600 text-black px-4 py-2 rounded mb-4" variant="primary">Tambah Peminjaman</flux:button>
    </div>
